...
class API():
    ...
    def print_advices(self, advices, indent=0):
        ...
        for advice in advices:
            ...
            utctime = datetime.datetime.strptime(advice.get('timestamp'), '%Y-%m-%dT%H:%M:%S.%fZ')
            localtime = utctime.replace(tzinfo=datetime.UTC).astimezone(tz=None)
...
class GUI():
    ...
    def __init__(self):
        ...
        self._checkbox_unchecked_enabled_img = tk.PhotoImage(
            data=(
                b'iVBORw0KGgoAAAANSUhEUgAAAA0AAAANCAIAAAD9iXMrAAAABGdBTUEAALGPC/xhBQAAAAlwSFlzAAAOww'
        ...
        self._checkbox_checked_enabled_img = tk.PhotoImage(
            data=(
                b'iVBORw0KGgoAAAANSUhEUgAAAA0AAAANCAIAAAD9iXMrAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8'
        ...
        self._checkbox_unchecked_disabled_img = tk.PhotoImage(
            data=(
                b'iVBORw0KGgoAAAANSUhEUgAAAA0AAAANCAIAAAD9iXMrAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZ'
        ...
        self._checkbox_checked_disabled_img = tk.PhotoImage(
            data=(
                b'iVBORw0KGgoAAAANSUhEUgAAAA0AAAANCAIAAAD9iXMrAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8Y'
