...
| **Filename** | `SPEC-001-v1.13-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.12 |

> **Versioning:** Updates require a new file (e.g. `SPEC-001-v1.14-...`). See [README.md](./README.md). Code changes require a new folder per [Codes/README.md](../Codes/README.md).
...
```powershell
cd "Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.13"
.\stop_service.ps1
```
...
| Item | Path |
|------|------|
| Solution code (active, v1.13) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.13\` |
| Solution code (frozen, v1.12) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.12\` |
| Session bridge plugin (no CSV) | `HIMA-Prooftest-Solution-v1.13\session_bridge_plugin.py` |
