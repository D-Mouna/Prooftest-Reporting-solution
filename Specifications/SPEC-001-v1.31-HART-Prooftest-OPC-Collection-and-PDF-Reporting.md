...
| **Filename** | `SPEC-001-v1.31-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.29 |
...
Cumulative record of specification and implementation updates. **The current version (1.31) is listed first**; summaries from all prior gated releases are retained below for audit. Active code: `HIMA-Prooftest-Solution-v1.31`.

### Version 1.31 (2026-06-19) — current

**Supersedes v1.29.** Active code folder: `HIMA-Prooftest-Solution-v1.31`. Prior folder `HIMA-Prooftest-Solution-v1.29` is **frozen** (gates 0–13 approved).
...
| Item | Path |
|------|------|
| Solution code (active, v1.31) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.31\` |
...
| **1.31** | **2026-06-19** | **Report Solution** | **List search:** `#device-search` and `#report-search` highlight matches and scroll without hiding rows; Enter cycles matches; active code `HIMA-Prooftest-Solution-v1.31` |
