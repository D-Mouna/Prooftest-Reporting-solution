...
| **Filename** | `SPEC-001-v1.60-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.59 |
...
**This version only** — relative to **v1.59**.  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.59.** Active code: `HIMA-Prooftest-Solution-Current`.
...
|---------|------|--------|-------|
| **1.60** | **2026-08-18** | **Report Solution** | Per-device source: OPC ProgID when on X-OPC, else SILworX project of detection |
