...
| **Filename** | `SPEC-001-v1.15-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.14 |
...
| **3** | `SilworxApiClient` REST wrapper | §4 Step 3.1 | **Done** (`prooftest/steps/step03_device_list.py`, `Tool test/test_silworx_api.py`) |
| **4** | First-run folders (nine Results-type folders + per-device subfolders), `deployment_case` | §4 Step 1 | **Done** (`prooftest/steps/step01_setup.py`, `Tool test/test_step4_install.py`) |
| **5** | All nine `ProofTest_*` SQL tables; generate missing `.sql` from CSV | §4 Step 2 | **Done** (`prooftest/steps/step02_database.py`, `Tool test/test_step5_sql.py`) |
...
```powershell
cd "Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.15"
.\stop_service.ps1
```
...
| Item | Path |
|------|------|
| Solution code (active, v1.15) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.15\` |
| Tool test scripts (G-15) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.15\Tool test\` |
| Solution code (frozen, v1.14) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.14\` |
| Session bridge plugin (no CSV) | `HIMA-Prooftest-Solution-v1.15\session_bridge_plugin.py` |
| Step-based code layout (G-14) | `HIMA-Prooftest-Solution-v1.15\prooftest\steps\` |
