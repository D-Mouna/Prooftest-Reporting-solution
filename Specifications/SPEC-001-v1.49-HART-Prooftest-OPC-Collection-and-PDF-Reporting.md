...
| **Filename** | `SPEC-001-v1.49-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.48 |
...
**This version only** — relative to **v1.48**.  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.48.** Active code: `HIMA-Prooftest-Solution-Current`.

#### What changed to v1.49

| Topic | Change |
|-------|--------|
| **G-11 on SILworX uninstall** | Solution **stays running**; releases only SILworX-blocking engines (API/plugin/`c3.exe`) |
| **Device list after uninstall** | Switches to **Case 2 OPC scanning** for device list and modification detection |
...
|---------|------|--------|-------|
| **1.49** | **2026-08-14** | **Report Solution** | G-11: on SILworX uninstall keep running; release blockers; switch to OPC Case 2 |
