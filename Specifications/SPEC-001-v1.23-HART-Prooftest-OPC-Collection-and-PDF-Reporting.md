...
| **Filename** | `SPEC-001-v1.23-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.22 |
...
sqlite_path = Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.23\Annex codes\data\prooftest.db
...
| Item | Path |
|------|------|
| Solution code (active, v1.23) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.23\` |
