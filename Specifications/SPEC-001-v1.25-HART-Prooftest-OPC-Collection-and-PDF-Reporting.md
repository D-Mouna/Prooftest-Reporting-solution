...
| **Filename** | `SPEC-001-v1.25-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.24 |
...
| **8** | Triggers + plugin bridge (multi-port `run_plugins_all.ps1`, `test_step8_triggers.py`) | **Done** (v1.25 — **await your approval** before Gate 9) |
...
- [x] Gate 8 — plugin bridge on all port pairs (`run_plugins_all.ps1`, `test_step8_triggers.py`, trigger refresh wiring).
