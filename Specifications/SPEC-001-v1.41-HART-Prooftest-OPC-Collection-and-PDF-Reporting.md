...
| **Filename** | `SPEC-001-v1.41-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.39 |
...
**This version only** — modifications relative to the superseded version (**v1.39**).  
Full history of all versions: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.39.** Active code: `HIMA-Prooftest-Solution-Current`.
...
| `VERSION.json` | 1.41 (spec pairing; no runtime behaviour change) |
...
|---------|------|--------|-------|
| **1.41** | **2026-08-12** | **Report Solution** | **G-12** moved from §2 general requirements to **Versioning** (process rule, not runtime requirement); wording aligned with Current + Archive |
