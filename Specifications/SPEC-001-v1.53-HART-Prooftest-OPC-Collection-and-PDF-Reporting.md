...
| **Filename** | `SPEC-001-v1.53-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.52 |
...
**This version only** — relative to **v1.52**.  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.52.** Active code: `HIMA-Prooftest-Solution-Current`.
...
|---------|------|--------|-------|
| **1.53** | **2026-08-17** | **Report Solution** | Refresh plugin `user_session_id` after the user opens a project; retry API attach |
