...
| **Filename** | `SPEC-001-v1.16-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.15 |
...
### 4.8 Code layout (G-16)

SPEC Step modules sit **next to** `service.py` under `prooftest\`. Annex modules group infrastructure by purpose:

```text
HIMA-Prooftest-Solution-v1.16/
  main.py, run_service.ps1, solution.ini
  ...
  prooftest/
    ...
    database.py, opc_manager.py, …  ← thin compatibility shims
    web/
```
...
| Item | Path |
|------|------|
| Solution code (active, v1.16) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.16\` |
| Tool test scripts (G-15) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.16\Tool test\` |
| Solution code (frozen, v1.15) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.15\` |
| SILworX plugin bridge (G-13) | `HIMA-Prooftest-Solution-v1.16\annex_plugin.py` |
| Steps + annex layout (G-16) | `HIMA-Prooftest-Solution-v1.16\prooftest\` |
