...
| **Filename** | `SPEC-001-v1.29-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.28 |
...
Cumulative record of specification and implementation updates. **The current version (1.29) is listed first**; summaries from all prior gated releases are retained below for audit. Active code: `HIMA-Prooftest-Solution-v1.29`.

### Version 1.29 (2026-06-19) — current

**Supersedes v1.28.** Active code folder: `HIMA-Prooftest-Solution-v1.29`. Prior folder `HIMA-Prooftest-Solution-v1.28` is **frozen**.
...
- [x] Gate 11 — Web UI + alarms gate test (`test_step11_web_ui.py`): API routes, `AlarmLog` persistence, health summary.
...
| Item | Path |
|------|------|
| Solution code (active, v1.29) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.29\` |
