...
| **Filename** | `SPEC-001-v1.44-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.43 |
...
**This version only** — modifications relative to the superseded version (**v1.43**).  
Full history of all versions: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.43.** Active code: `HIMA-Prooftest-Solution-Current`. Spec-only (manual edits in v1.43 preserved).

#### What changed from v1.43 to v1.44

| Topic | v1.43 | v1.44 (change) |
|-------|-------|----------------|
| **G-14 … G-17 placement** | Listed under §2 **General specifications** | Moved to **Solution structure** — code-organization rules, not runtime requirements |
| **Manual edits** | User edits in v1.43 (e.g. G-14 wording, template-folder notes) | **Kept** as-is in the relocated rows / body |

#### Description of v1.44 modifications

1. Removed **G-14**, **G-15**, **G-16**, and **G-17** from the §2 general requirements table.
2. Added top-level **Solution structure** section (with those four rules unchanged in wording).
3. §2 points to Versioning and Solution structure for process/layout rules.

#### Files touched for v1.44

| File | Change |
|------|--------|
| `SPEC-001-v1.44-...` | Solution structure section; G-14–G-17 relocated |
| `History of Modifications.md` / `Specifications/README.md` | Current → 1.44 |
| `VERSION.json` | 1.44 (spec pairing) |
...
|---------|------|--------|-------|
| **1.44** | **2026-08-12** | **Report Solution** | **G-14–G-17** moved from §2 general requirements to **Solution structure** (code layout rules); user manual edits from v1.43 preserved |
