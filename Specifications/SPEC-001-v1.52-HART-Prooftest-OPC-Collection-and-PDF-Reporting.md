...
| **Filename** | `SPEC-001-v1.52-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.51 |
...
**This version only** — relative to **v1.51**.  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.51.** Active code: `HIMA-Prooftest-Solution-Current`.
...
|---------|------|--------|-------|
| **1.52** | **2026-08-17** | **Report Solution** | Never open SILworX project; API only if user has project open, else OPC |
| **1.51** | **2026-08-14** | **Report Solution** | Remove separate Case 2; unified API→OPC mode only |
| **1.50** | **2026-08-14** | **Report Solution** | When SILworX/API unavailable: periodic OPC scan for device list updates |
