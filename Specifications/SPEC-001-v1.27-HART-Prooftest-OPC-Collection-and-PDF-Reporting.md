...
| **Filename** | `SPEC-001-v1.27-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.26 |
...
Cumulative record of specification and implementation updates. **The current version (1.27) is listed first**; summaries from all prior gated releases are retained below for audit. Active code: `HIMA-Prooftest-Solution-v1.27`.

### Version 1.27 (2026-06-18) — current

**Supersedes v1.26.** Active code folder: `HIMA-Prooftest-Solution-v1.27`. Prior folder `HIMA-Prooftest-Solution-v1.26` is **frozen** (no further edits).
...
| Item | Path |
|------|------|
| Solution code (active, v1.27) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.27\` |
