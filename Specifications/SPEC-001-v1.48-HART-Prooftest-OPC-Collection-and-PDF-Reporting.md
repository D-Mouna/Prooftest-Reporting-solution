...
| **Filename** | `SPEC-001-v1.48-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.47 |
...
**This version only** — modifications relative to the superseded version (**v1.47**).  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.47.** Active code: `HIMA-Prooftest-Solution-Current`.

#### What changed to v1.48

| Topic | Change |
|-------|--------|
| **First run** | Create `C:\HIMA Prooftest Reporting Tool` with exactly three folders: **Database**, **HIMA Automated Prooftest Reports**, **Results Structures** |
| **Database** | Create DB + `ProofTest_*` tables; SQL files / SQLite under `Database\` |
| **Results Structures** | Seed nine CSVs; **new CSV** = new Results / device type |
| **Report templates** | Auto-create Proof-test HTML report template for each type (seed known nine; generate for new CSVs) under `...\HIMA Automated Prooftest Reports\Report Templates\` |
...
|---------|------|--------|-------|
| **1.48** | **2026-08-14** | **Report Solution** | First-run: 3 station folders; DB in Database; new CSV → type + auto report template |
