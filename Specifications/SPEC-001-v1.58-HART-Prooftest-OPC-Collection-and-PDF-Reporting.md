...
| **Filename** | `SPEC-001-v1.58-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.57 |
...
**This version only** — relative to **v1.57**.  
Full history: [History of Modifications.md](./History%20of%20Modifications.md).

**Supersedes v1.57.** Active code: `HIMA-Prooftest-Solution-Current`.
...
|---------|------|--------|-------|
| **1.58** | **2026-08-17** | **Report Solution** | Panel order Health\|Devices / Reports\|Alarms; browse restore; alarm still-active window, ack, reset |
