...
| **Filename** | `SPEC-001-v1.20-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.19 |
...
sqlite_path = Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.20\Annex codes\data\prooftest.db
...
| Item | Path |
|------|------|
| Solution code (active, v1.20) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.20\` |
