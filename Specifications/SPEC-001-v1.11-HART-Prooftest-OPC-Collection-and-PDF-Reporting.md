...
| **Filename** | `SPEC-001-v1.11-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.10 |

> **Versioning:** Updates require a new file (e.g. `SPEC-001-v1.12-...`). See [README.md](./README.md).
...
```powershell
cd "Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution"
.\stop_service.ps1
```
