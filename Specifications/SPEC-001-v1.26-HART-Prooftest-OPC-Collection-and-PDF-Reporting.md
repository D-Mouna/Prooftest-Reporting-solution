...
| **Filename** | `SPEC-001-v1.26-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.25 |
...
| **8** | Triggers + plugin bridge (multi-port monitor, `test_step8_triggers.py`) | **Done** (v1.26 G-22 — **await your approval** before Gate 9) |
| **9** | Prooftest SQL insert on completion (Step 5) | **Code done** — gate test pending |
| **10** | HIMA PDF/HTML reports (Step 6) | **Code done** — template hardening pending |
| **11** | Web UI + alarms | **Code done** — polish pending |
...
- [x] Gate 8 — plugin monitor on all port pairs (`annex_plugin_monitor.py`, `test_step8_triggers.py`, multi-session triggers, G-22).
- [ ] Gate 9 — prooftest SQL gate test (`test_step9_prooftest_sql.py`).
...
| Item | Path |
|------|------|
| Solution code (active, v1.25) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.25\` |
| Solution code (frozen, v1.24) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.24\` |
...
| **1.26** | **2026-06-17** | **Report Solution** | **G-22 three-layer architecture:** REST API-only data path; persistent plugin monitor on all 10 port pairs (`annex_plugin_monitor.py`); multi-session `c3data`/`.E3` triggers; independent OPC poll loop documented; active code `HIMA-Prooftest-Solution-v1.26` |
