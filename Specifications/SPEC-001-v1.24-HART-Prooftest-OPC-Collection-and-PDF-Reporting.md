...
| **Filename** | `SPEC-001-v1.24-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.23 |
...
| **8** | Triggers + plugin bridge (multi-port `run_plugins_all.ps1`) | **In progress** (v1.24) |
...
sqlite_path = Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.24\Annex codes\data\prooftest.db
...
- [ ] Gate 8 — plugin bridge on all port pairs (`run_plugins_all.ps1`, `test_step8_triggers.py`).
- [ ] Gate 9–13 — prooftest SQL gate test, report templates, Web UI polish, Case 2 validation, hardening.
...
| Item | Path |
|------|------|
| Solution code (active, v1.24) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.24\` |
