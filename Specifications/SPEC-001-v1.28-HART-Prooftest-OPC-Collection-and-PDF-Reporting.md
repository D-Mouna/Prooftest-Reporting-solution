...
| **Filename** | `SPEC-001-v1.28-HART-Prooftest-OPC-Collection-and-PDF-Reporting.md` |
| **Supersedes** | v1.27 |
...
Cumulative record of specification and implementation updates. **The current version (1.28) is listed first**; summaries from all prior gated releases are retained below for audit. Active code: `HIMA-Prooftest-Solution-v1.28`.

### Version 1.28 (2026-06-19) — current

**Supersedes v1.27.** Active code folder: `HIMA-Prooftest-Solution-v1.28`. Prior folder `HIMA-Prooftest-Solution-v1.27` is **frozen** (no further edits).
...
| Item | Path |
|------|------|
| Solution code (active, v1.28) | `Z:\Project\Report Solution\Codes\HIMA-Prooftest-Solution-v1.28\` |
...
| **1.28** | **2026-06-19** | **Report Solution** | **Web GUI:** Start/Stop service buttons (`POST /api/start`, `POST /api/shutdown`); scroll lists always visible with `(No device selected)` / `(No report selected)` placeholders; active code `HIMA-Prooftest-Solution-v1.28` |
